...
const layerCards = [
  {
    title: "Biome Scan",
    detail:
      "Pin a site and instantly cross-check floodplain pressure, habitat overlap, and policy constraints before design work starts.",
  ...
  },
  {
    ...
    detail:
      "Describe what you plan to build and the engine ranks Ontario zones by ecological fit, permitting friction, and readiness.",
  ...
  },
  {
    title: "Trail Log",
    detail:
      "Save every location review in one workspace so teams can compare options and move from intuition to evidence.",
...
const trailSteps = [
  {
    ...
    description: "Search or drop a marker on the map where you want to explore development potential.",
  },
  {
    title: "Let The Canopy Read",
    description: "TerraCheck inspects six live geospatial layers and routes evidence to AI for synthesis.",
  },
  {
    title: "Choose The Safest Route",
    description: "Receive viability scores, blockers, and practical next actions for planners and stakeholders.",
  },
];
          ...
          <div className="mx-auto grid max-w-6xl gap-14 px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className={`transition-all duration-700 ${heroVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/assess" className="inline-flex items-center justify-center rounded-full bg-[#c6b07a] px-7 py-3 text-sm font-semibold tracking-wide text-[#1d2518] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#d4be86]">
                  Start Land Reading
                </Link>
                <Link href="/recommend" className="inline-flex items-center justify-center rounded-full border border-[#9bb48b]/45 bg-[#152218]/70 px-7 py-3 text-sm font-semibold tracking-wide text-[#dce7d1] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#1d2f20]">
                  Explore AI Site Finder
                </Link>
              </div>
              <div className="mt-8 grid max-w-xl grid-cols-1 gap-3 text-sm text-[#d8d1bf] sm:grid-cols-3">
                <div className="forest-chip">
                  <p className="text-lg font-semibold text-[#f2ecd8]">6</p>
                  <p>Live layers</p>
                </div>
                <div className="forest-chip">
                  <p className="text-lg font-semibold text-[#f2ecd8]">47</p>
                  <p>Zones compared</p>
                </div>
                <div className="forest-chip">
                  <p className="text-lg font-semibold text-[#f2ecd8]">100%</p>
                  <p>AI assisted</p>
                </div>
              </div>
            </div>
              ...
              <div className="forest-card relative overflow-hidden p-7 md:p-9" style={{ transform: `translateY(${Math.min(scrollY * -0.045, 18)}px)` }}>
                ...
                <div className="mt-8 space-y-2 text-sm">
                  <div className="forest-row">
                    ...
                    <span className="text-[#bfd9ac]">Low</span>
                  </div>
                  <div className="forest-row">
                    <span>Protected habitat</span>
                    <span className="text-[#f0d189]">Watch</span>
                  </div>
                  <div className="forest-row">
                    <span>Policy friction</span>
                    <span className="text-[#bfd9ac]">Manageable</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className={`mt-10 grid gap-5 md:grid-cols-3 transition-all duration-700 ${layersVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
              {layerCards.map((card, index) => (
                <article
                  key={card.title}
                  className="forest-panel group relative overflow-hidden p-6"
                  style={{ transform: `translateY(${scrollY * (index + 1) * -0.008}px)` }}
                >
                  ...
                  <Link
                    href={card.href}
                    className="mt-5 inline-flex items-center text-sm font-semibold text-[#c8dda8] transition-all duration-300 group-hover:translate-x-1"
                  >
                    Enter route
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
              <div>
                ...
                <p className="mt-4 max-w-md text-sm leading-relaxed text-[#cec7b4]">
                  This flow mimics a forest walk: observe, interpret, then commit to a route. Every step keeps legal and environmental risk visible.
                </p>
              </div>
              ...
              <div className={`space-y-6 transition-all duration-700 ${processVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                {trailSteps.map((step, index) => (
                  <div key={step.title} className="forest-panel relative p-5 pl-16">
                    <div className="absolute left-5 top-5 flex h-9 w-9 items-center justify-center rounded-full border border-[#9bb38b]/45 bg-[#19271d] text-sm font-semibold text-[#d8e9c7]">
                      {index + 1}
                    </div>
        ...
        <section ref={ctaRef} className="pb-24 pt-20 md:pb-28">
          <div className={`mx-auto max-w-4xl px-6 transition-all duration-700 ${ctaVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
            <div className="forest-card relative overflow-hidden px-7 py-10 text-center md:px-12 md:py-14">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-[#d5cebc] md:text-base">
                Walk into planning meetings with evidence, not assumptions. TerraCheck keeps your route grounded in ecology, regulation, and practical delivery.
              </p>
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                <Link href="/assess" className="inline-flex items-center justify-center rounded-full bg-[#c6b07a] px-8 py-3 text-sm font-semibold tracking-wide text-[#1d2518] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#d5bf87]">
                  Assess A Site
                </Link>
                <Link href="/recommend" className="inline-flex items-center justify-center rounded-full border border-[#98b18a]/50 bg-[#162319]/75 px-8 py-3 text-sm font-semibold tracking-wide text-[#d7e3cb] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#203122]">
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
            ...
            <div className="flex items-center gap-4">
              <Link href="/assess" className="text-xs text-[#a8b7a0] transition-colors hover:text-[#dbe8cf]">Assess</Link>
              <Link href="/recommend" className="text-xs text-[#a8b7a0] transition-colors hover:text-[#dbe8cf]">Recommend</Link>
              <Link href="/dashboard" className="text-xs text-[#a8b7a0] transition-colors hover:text-[#dbe8cf]">Dashboard</Link>
              <Link href="/demo" className="text-xs text-[#a8b7a0] transition-colors hover:text-[#dbe8cf]">Demo</Link>
            </div>
          </div>
          <div className="border-t border-[#2a3b2b] mt-4 pt-4 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-xs text-[#7a8d74] hover:text-[#dbe8cf] transition-colors flex items-center gap-1"
              >
