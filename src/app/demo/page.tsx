        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              <Link href={`${P}/assess`} className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-primary-dark rounded-lg text-sm font-semibold hover:bg-white/90 transition-all shadow-lg shadow-black/10">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                Start Assessment
              </Link>
              <Link href={`${P}/recommend`} className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white/10 backdrop-blur-sm text-white border border-white/20 rounded-lg text-sm font-semibold hover:bg-white/20 transition-all">
      ...
      <section ref={cta.ref} className="py-20 md:py-28 bg-gradient-to-br from-primary-dark via-primary to-primary-light">
        <div className={`max-w-3xl mx-auto px-6 text-center transition-all duration-700 ${cta.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href={`${P}/assess`} className="px-8 py-3.5 bg-white text-primary-dark rounded-lg text-sm font-semibold hover:bg-white/90 transition-all shadow-lg">
              Start Your First Assessment
            </Link>
            <Link href={`${P}/recommend`} className="px-8 py-3.5 bg-white/10 text-white border border-white/20 rounded-lg text-sm font-semibold hover:bg-white/20 transition-all">
              Try AI Site Finder
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div className="flex gap-4">
              <Link href={`${P}/assess`} className="text-xs text-white/40 hover:text-white/70 transition-colors">Assess</Link>
              <Link href={`${P}/recommend`} className="text-xs text-white/40 hover:text-white/70 transition-colors">Recommend</Link>
              <Link href={`${P}/dashboard`} className="text-xs text-white/40 hover:text-white/70 transition-colors">Dashboard</Link>
            </div>
          </div>
