    ...
    mitigations: [
      {
        ...
        action: "Engage a planner experienced with Greenbelt Plan applications. Consider focusing development on the 60% of the site outside the Greenbelt boundary.",
        cost_estimate: "$15,000-$25,000",
      },
      {
        issue: "Rezoning required",
        action: "Prepare a comprehensive Planning Justification Report with traffic impact study and servicing report.",
...
export default function DemoAssessPage() {
  ...
  // Auto-start: drop pin and begin assessment on mount
  useEffect(() => {
    if (hasAutoStarted.current) return;
    hasAutoStarted.current = true;
    const timer = setTimeout(() => {
      handlePinDrop(43.2557, -79.8711);
    }, 1200);
